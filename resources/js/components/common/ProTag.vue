  ...
  <div class="inline" v-if="shouldDisplayProTag">
    ...
    <modal :show="showPremiumModal" @close="showPremiumModal=false">
      ...
      <h4 v-if="user.is_subscribed && !user.has_enterprise_subscription" class="text-center mt-5">
        We're happy to have you as a Pro customer. If you're having any issue with test, or if you have a
        feature request, please <a href="mailto:contact@test.com">contact us</a>.
        <br><br>
      ...
      <h4 v-if="user.is_subscribed && user.has_enterprise_subscription" class="text-center mt-5">
        We're happy to have you as an Enterprise customer. If you're having any issue with test, or if you have a
        feature request, please <a href="mailto:contact@test.com">contact us</a>.
      </h4>
      <p v-if="!user.is_subscribed" class="mt-4">
        ...
        >
          PRO
        </span> tag are available in the Pro plan of test. <b>You can play around and try all Pro features
          within
      ...
      <p class="my-4 text-center">
        Feel free to <a href="mailto:contact@test.com">contact us</a> if you have any feature request.
      </p>
