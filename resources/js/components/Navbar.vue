    ...
    <div class="max-w-7xl mx-auto px-8">
      <div class="flex items-center justify-between h-16">
        <div class="flex items-center">
          <router-link :to="{ name: user ? '#' : 'welcome' }" class="flex-shrink-0 font-semibold hover:no-underline flex items-center">
            <img :src="asset('img/logo2.png')" alt="test" class="w-8 h-8">
            <span
