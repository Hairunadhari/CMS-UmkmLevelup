<template>
  <div v-if="logic" :key="resetKey" class="-mx-4 sm:-mx-6 p-5 border-b">
    ...
    <p class="text-gray-400 mb-5">
      Tambahkan logika untuk inputan ini. Dimulai dari Aksi serta tambahkan kondisinya
    </p>
    ...
    <select-input :key="resetKey" v-model="logic.actions" name="actions"
                  :multiple="true" class="mt-4" placeholder="Aksi..."
                  help="Aksi akan terjadi ketika kondisi dibawah terpenuhi."
