          ...
          <div class="pt-4 pb-0">
            ...
            <div class="flex">
              ...
              <div class="flex">
                ...
                <v-button class="btn btn-orange text-white mr-2" @click="setLevel">
            ...
            <ul class="flex text-gray-500">
              ...
              <li v-if="form.visibility=='draft'" class="list-disc ml-6 pr-1 text-blue-500">
                Draft (not public)
              </li>
              <li v-if="form.visibility=='closed'" class="list-disc ml-6 pr-1 text-blue-500">
                Closed
              </li>
