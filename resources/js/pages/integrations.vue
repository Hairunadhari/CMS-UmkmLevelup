...
export default {
  ...
  props: {
    ...
    metaDescription: { type: String, default: 'You can connect your forms to other services via our two integrations: Zapier and Webhooks. Use our integrations to automate your various workflows.' }
  },
